                ...
                if self.__frontier_explored_test(frontier,explored_set,state):#该节点未访问过
                        ...
                        if not already_in is None:
                            if already_in.get_fvalue()>state.get_fvalue():
                                ...
                                found_result[state.get_id()] = child_node  # 更换
